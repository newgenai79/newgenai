        ...
        with gr.Tab("Generate image"):
            ...
            with gr.Row():
                ...
                with gr.Column():
                    ...
                    guidance_scale_slider = gr.Slider(label="Guidance Scale", minimum=1.0, maximum=20.0, value=7.0, step=0.1)
                    num_inference_steps_input = gr.Number(label="Number of Inference Steps", value=30)
        ...
        with gr.Tab("Batch Processing"):
            ...
            with gr.Row():
                ...
                with gr.Column():
                    ...
                    batch_guidance_scale_slider = gr.Slider(label="Guidance Scale", minimum=1.0, maximum=20.0, value=7.0, step=0.1)
                    batch_num_inference_steps_input = gr.Number(label="Number of Inference Steps", value=30)
